    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel"> {{trans('trans_gen.del')}} {{$online_classe->topic}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('online_zoom_classes.destroy',$online_classe->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">  {{trans('trans_gen.delete')}}</h5>
