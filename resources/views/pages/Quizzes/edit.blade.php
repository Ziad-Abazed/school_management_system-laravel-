...
@section('css')
    @toastr_css
@section('title')
{{trans('trans_gen.edit')}} {{$quizz->name}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.update','test')}}" method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <label for="title">   {{trans('trans_gen.testAR')}} </label>
                                    ...
                                    <div class="col">
                                        <label for="title">    {{trans('trans_gen.testER')}} </label>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id"> {{trans('trans_gen.Subject')}}  : <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            <label for="Grade_id"> {{trans('main_trans.teachername')}}  : <span class="text-danger">*</span></label>
