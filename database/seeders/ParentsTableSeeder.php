...
class ParentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $my_parents->Nationality_Father_id = Nationalitie::all()->UNIQUEID()->random()->id;
        $my_parents->Blood_Type_Father_id =Type_blood::all()->UNIQUEID()->random()->id;
        $my_parents->Religion_Father_id = Religion::all()->UNIQUEID()->random()->id;
        ...
        $my_parents->Nationality_Mother_id = Nationalitie::all()->UNIQUEID()->random()->id;
        $my_parents->Blood_Type_Mother_id =Type_Blood::all()->UNIQUEID()->random()->id;
        $my_parents->Religion_Mother_id = Religion::all()->UNIQUEID()->random()->id;
